    ...
    <section id="datenschutz" className="content-section">
      ...
      <div className="service-grid">
        <article className="service-card">
          ...
          <p>
            Der Verantwortliche entscheidet allein oder gemeinsam mit anderen über die
        ...
        <article className="service-card">
          <h3>2. Hosting</h3>
          <p>
            Diese Website wird bei dem Anbieter Netlify, Inc., 2325 3rd Street, Suite
            296, San Francisco, CA 94107, USA gehostet.
          </p>
          <p>
            Netlify stellt die Infrastruktur und Plattform zum Betrieb dieser Website
            bereit. Beim Aufruf der Website werden durch Netlify automatisch
            Informationen in sogenannten Server-Logfiles erfasst.
          </p>
          ...
          <p>
            ...
            Bereitstellung der Website sowie zur Gewährleistung der Stabilität und
          ...
          <p>
            Da Netlify ein Unternehmen mit Sitz in den USA ist, kann eine Übermittlung
            personenbezogener Daten in ein Drittland erfolgen. Die Datenübermittlung
        ...
        <article className="service-card">
          ...
          <p>
            Auf dieser Website ist ein Kontaktformular vorhanden, über das Sie mit uns
          ...
          <p>
            ...
            gespeichert, wie dies zur Bearbeitung Ihrer Anfrage erforderlich ist oder
        ...
        <article className="service-card">
          ...
          <p>
            ...
            Browsers von „http://“ auf „https://“ wechselt sowie an dem Schloss-Symbol
        ...
        <article className="service-card">
          ...
          <p>
            Zur Ausübung Ihrer Rechte können Sie sich jederzeit an den oben genannten
        ...
        <article className="service-card">
          ...
          <p>Zuständige Aufsichtsbehörde in Nordrhein-Westfalen ist beispielsweise:</p>
          <p>
          ...
          <p>
            Sie können sich jedoch auch an jede andere Datenschutzaufsichtsbehörde
            innerhalb der Europäischen Union wenden.
          </p>
        </article>
